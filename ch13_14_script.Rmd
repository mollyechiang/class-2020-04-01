...
A one unit difference in ideology corresponds to a -0.4 difference in the coef for raceWhite. raceWhite has a negative coef, so increases in ideology increase this negative association. This makes sense as white people with more conservative ideologies are less likely to vote democrat.
